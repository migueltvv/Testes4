...
if(lego_loam2_CONFIG_INCLUDED)
  return()
endif()
set(lego_loam2_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(lego_loam2_SOURCE_PREFIX /home/safe/gitsinced/src/LeGO-LOAM2/LeGO-LOAM)
  set(lego_loam2_DEVEL_PREFIX /home/safe/gitsinced/devel)
  set(lego_loam2_INSTALL_PREFIX "")
  set(lego_loam2_PREFIX ${lego_loam2_DEVEL_PREFIX})
else()
  set(lego_loam2_SOURCE_PREFIX "")
  set(lego_loam2_DEVEL_PREFIX "")
  set(lego_loam2_INSTALL_PREFIX /home/safe/gitsinced/install)
  set(lego_loam2_PREFIX ${lego_loam2_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'lego_loam2' is deprecated")
...
set(lego_loam2_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/safe/gitsinced/src/LeGO-LOAM2/LeGO-LOAM/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(lego_loam2_INCLUDE_DIRS "")
  set(_include_dirs "/home/safe/gitsinced/src/LeGO-LOAM2/LeGO-LOAM/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${lego_loam2_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lego_loam2' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'lego_loam2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/safe/gitsinced/src/LeGO-LOAM2/LeGO-LOAM/${idir}'.  ${_report}")
    endif()
    _list_append_unique(lego_loam2_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND lego_loam2_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND lego_loam2_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT lego_loam2_NUM_DUMMY_TARGETS)
      set(lego_loam2_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lego_loam2::wrapped-linker-option${lego_loam2_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lego_loam2_NUM_DUMMY_TARGETS "${lego_loam2_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lego_loam2::wrapped-linker-option${lego_loam2_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lego_loam2_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(lego_loam2_LIBRARY_DIRS ${lib_path})
      list(APPEND lego_loam2_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'lego_loam2'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND lego_loam2_LIBRARIES ${lib})
    endif()
  endif()
...
set(lego_loam2_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${lego_loam2_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 lego_loam2_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${lego_loam2_dep}_FOUND)
      find_package(${lego_loam2_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lego_loam2_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(lego_loam2_INCLUDE_DIRS ${${lego_loam2_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(lego_loam2_LIBRARIES ${lego_loam2_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${lego_loam2_dep}_LIBRARIES})
  _list_append_deduplicate(lego_loam2_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(lego_loam2_LIBRARIES ${lego_loam2_LIBRARIES})

  _list_append_unique(lego_loam2_LIBRARY_DIRS ${${lego_loam2_dep}_LIBRARY_DIRS})
  list(APPEND lego_loam2_EXPORTED_TARGETS ${${lego_loam2_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${lego_loam2_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
