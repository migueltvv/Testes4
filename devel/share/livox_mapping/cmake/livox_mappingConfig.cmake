...
if(livox_mapping_CONFIG_INCLUDED)
  return()
endif()
set(livox_mapping_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(livox_mapping_SOURCE_PREFIX /home/safe/gitsinced/src/livox_mapping)
  set(livox_mapping_DEVEL_PREFIX /home/safe/gitsinced/devel)
  set(livox_mapping_INSTALL_PREFIX "")
  set(livox_mapping_PREFIX ${livox_mapping_DEVEL_PREFIX})
else()
  set(livox_mapping_SOURCE_PREFIX "")
  set(livox_mapping_DEVEL_PREFIX "")
  set(livox_mapping_INSTALL_PREFIX /home/safe/gitsinced/install)
  set(livox_mapping_PREFIX ${livox_mapping_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'livox_mapping' is deprecated")
...
set(livox_mapping_FOUND_CATKIN_PROJECT TRUE)
...
if(NOT "/usr/include/eigen3;/usr/include/pcl-1.8;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl;/usr/include/opencv " STREQUAL " ")
  set(livox_mapping_INCLUDE_DIRS "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${livox_mapping_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'livox_mapping' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'livox_mapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/safe/gitsinced/src/livox_mapping/${idir}'.  ${_report}")
    endif()
    _list_append_unique(livox_mapping_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND livox_mapping_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND livox_mapping_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT livox_mapping_NUM_DUMMY_TARGETS)
      set(livox_mapping_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::livox_mapping::wrapped-linker-option${livox_mapping_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR livox_mapping_NUM_DUMMY_TARGETS "${livox_mapping_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::livox_mapping::wrapped-linker-option${livox_mapping_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND livox_mapping_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(livox_mapping_LIBRARY_DIRS ${lib_path})
      list(APPEND livox_mapping_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'livox_mapping'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND livox_mapping_LIBRARIES ${lib})
    endif()
  endif()
...
set(livox_mapping_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${livox_mapping_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 livox_mapping_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${livox_mapping_dep}_FOUND)
      find_package(${livox_mapping_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${livox_mapping_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(livox_mapping_INCLUDE_DIRS ${${livox_mapping_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(livox_mapping_LIBRARIES ${livox_mapping_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${livox_mapping_dep}_LIBRARIES})
  _list_append_deduplicate(livox_mapping_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(livox_mapping_LIBRARIES ${livox_mapping_LIBRARIES})

  _list_append_unique(livox_mapping_LIBRARY_DIRS ${${livox_mapping_dep}_LIBRARY_DIRS})
  list(APPEND livox_mapping_EXPORTED_TARGETS ${${livox_mapping_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${livox_mapping_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
